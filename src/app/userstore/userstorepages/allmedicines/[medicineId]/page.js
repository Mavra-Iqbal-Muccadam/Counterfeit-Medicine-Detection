              ...
              <Grid item xs={12} md={8}>
                <CardContent sx={{ p: { xs: 2, sm: 3 } }}>
                  ...
                  <Box sx={{ mb: 2 }}>
                    <Typography
                      variant="subtitle1"
                      sx={{ mb: 1.5, fontWeight: "bold", fontSize: "1.1rem" }}
                    >
                      Product Details
                    </Typography>
                  ...
                  <Box
                    sx={{
                      ...
                      p: 1,
                      backgroundColor:
                        medicine.quantity > 0 ? "#e8f5e9" : "#ffebee",
                      borderRadius: 1,
                      border: `1px solid ${
                        medicine.quantity > 0 ? "#e8f5e9" : "#ffcdd2"
                      }`,
                    }}
                  >
                    <Typography
                  ...
                  {medicine.quantity > 0 && (
                    <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
                      <Typography
                        variant="subtitle1"
                        sx={{ mr: 2, fontWeight: "bold", fontSize: "0.95rem" }}
                      >
                        Qty:
                      </Typography>
                      <IconButton
