    ...
    if (searchTerm.trim() === "") {
      ...
      const filtered = medicines.filter(
        (medicine) =>
          ...
          (medicine.excipients &&
            medicine.excipients.some((excipient) =>
    ...
    <>
      ...
      >
        <Container maxWidth="xl">
          ...
          >
            Browse through our comprehensive collection of pharmaceutical
            products
          </Typography>
          ...
          {filteredMedicines.length === 0 ? (
            <Typography
              variant="h6"
              sx={{ textAlign: "center", mt: 5, color: "#002F6C" }}
            >
              {searchTerm
                      ...
                      <CardContent sx={{ flexGrow: 1, p: 1.5 }}>
                        ...
                        {medicine.excipients &&
                          medicine.excipients.length > 0 && (
                            ...
                            >
                              {medicine.excipients.slice(0, 2).join(", ")}
                              {medicine.excipients.length > 2 ? "..." : ""}
                            </Typography>
                          )}
                        <Box
                          sx={{
