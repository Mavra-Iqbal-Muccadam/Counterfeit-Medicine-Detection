...
const CustomStepIcon = styled("div")(({ theme, active, completed }) => ({
  ...
  height: 32,
  borderRadius: "50%",
  backgroundColor: completed ? "#4CAF50" : active ? "#002F6C" : "#e0e0e0",
  color: "#fff",
  display: "flex",
  alignItems: "center",
...
const StepConnector = styled("div")(({ theme, active }) => ({
  height: 2,
...
const ShippingForm = ({ formData, onSubmit, orderTotal }) => {
  ...
  const validate = () => {
    ...
    if (!formState.phone) newErrors.phone = "Phone number is required";
      ...
      newErrors.phone =
        "Phone number must start with 0 and be 11 digits (e.g., 03001234567)";
    }
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12}>
            <TextField
              ...
              helperText={
                errors.phone ||
                "Enter in international format (e.g., 03001234567)"
              }
              InputLabelProps={{ shrink: true }}
              sx={{ mb: 2 }}
            />
  ...
  return (
    <Box>
      <Typography
        ...
        sx={{
          fontWeight: "bold",
          color: disabled ? "text.secondary" : "#002F6C",
          mb: 2,
        }}
      >
        Payment Method
      ...
      >
        <Box
          sx={{
            ...
            border: "2px solid",
            borderColor:
              selectedMethod === "paypro" ? "#002F6C" : "transparent",
            bgcolor:
      ...
      {selectedMethod === "paypro" && (
        <Paper variant="outlined" sx={{ p: 2, mt: 2 }}>
          <Typography variant="body2" sx={{ mb: 2 }}>
            You will be redirected to PayPro's secure payment page to complete
            your transaction.
          </Typography>
          <Typography variant="caption" color="text.secondary">
            PayPro supports all major credit/debit cards and mobile payment
            methods.
          </Typography>
        </Paper>
      )}
...
const OrderSummary = ({ cartItems, orderSummary, handleRemoveItem }) => {
  ...
  return (
    <Paper sx={{ p: 3, position: "relative" }}>
      <Typography
        variant="h6"
        sx={{ fontWeight: "bold", color: "#002F6C", mb: 3 }}
      >
        Order Summary
      </Typography>
      ...
      >
        ...
        <Typography
          variant="subtitle1"
          sx={{ fontWeight: 700, color: "#002F6C" }}
        >
  ...
  useEffect(() => {
    ...
    const loadMedicines = async () => {
      try {
        ...
        const cartItems = medicineIds
          .map((medicineId, index) => {
        ...
        <Button
          ...
          onClick={() => {
            localStorage.setItem(
              "redirectAfterLogin",
              "/userstore/userstorepages/allmedicines/cart",
            );
      ...
      >
        <Container maxWidth="xl">
          <Box sx={{ textAlign: "center", mb: 4, mt: 5 }}>
            ...
            >
              Complete your purchase to get your medications delivered to your
              doorstep
            </Typography>
          </Box>
                ...
                {activeStep === 3 && (
                  <Paper sx={{ p: 4, mt: 3, textAlign: "center" }}>
                    ...
                    <Typography variant="body2" sx={{ mb: 3 }}>
                      ...
                      <strong>
                        PHARM-{Date.now().toString().substring(6)}
                      </strong>
                    </Typography>
                    <Button
                      variant="outlined"
