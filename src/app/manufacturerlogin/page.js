...
import {
  ...
  loginWithMetaMask,
} from "../testingblockchain/login-status-manufacture/check";
import {
  SuccessMsgBox,
  ErrorMsgBox,
  InfoMsgBox,
          ...
          <Grid container spacing={4}>
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                <Typography
                  variant="h4"
                  sx={{ mb: 3, color: "#002F6C", fontWeight: 600 }}
                >
                  Manufacturer Login
                </Typography>
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                <Typography
                  variant="h5"
                  sx={{ mb: 2, color: "#002F6C", fontWeight: 600 }}
                >
                  New Manufacturer?
                </Typography>
                <Typography variant="body1" sx={{ mb: 3 }}>
                  Register your pharmaceutical company to join our network and
